...
DEPOSIT_MONITOR_INTERVAL_MINUTES = int(os.getenv('DEPOSIT_MONITOR_INTERVAL_MINUTES', '1'))
WITHDRAWAL_PROCESSOR_INTERVAL_MINUTES = int(os.getenv('WITHDRAWAL_PROCESSOR_INTERVAL_MINUTES', '1'))